...
import com.andev.androidshaderdemo.filter.ImageFilter;
...
public class CameraView extends GLSurfaceView implements GLSurfaceView.Renderer{
	...
	private boolean isFrameBufferInited;
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		imageFilter = new ImageFilter(context);
	}
	...
	public void onDrawFrame(GL10 gl) {
		...
		if(imageFilter == null){
			...
			imageFilter.onDrawFrame(frameTextureID);
		}
	}
