...
public class GaussianProgram extends ShaderProgram{
	...
	public GaussianProgram(Context context) {
		super(context, R.raw.gaussian_vertex_shader, R.raw.gaussian_fragment_shader);
